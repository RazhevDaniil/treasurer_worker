...
class DbClient:
    ...
    def get_task(self, task_id: str) -> Task | None:
        ...
        resp = self._client.get(f"/v1/approve/tasks/{task_id}")
    ...
    def list_tasks_by_status(
        ...
        resp = self._client.get("/v1/approve/tasks", params=params)
        resp.raise_for_status()
    ...
    def get_snapshot_by_task(self, task_id: str) -> dict | None:
        ...
        resp = self._client.get(f"/v1/approve/snapshots/by-task/{task_id}")
        if resp.status_code == 404:
            return None
        resp.raise_for_status()
        return resp.json()
